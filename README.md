...
| 로컬 유사 종목 계산기 | ✅ 완료 | 2,601개 기업, 상위 후보 26,010개 |
| 전체 종목 국내 peer 연결 | ✅ 완료 | 사업 프로필과 상위 국내 후보 5개 표시 |
| 전체 종목 글로벌 peer 확장 | ✅ 완료 | 7개 테마 규칙으로 한국 종목 489개 연결 |
...
현재 2,822개 한국 상장 종목 중 근거 기준을 통과한 489개 종목에 글로벌 peer
...
현재 Node 테스트 20개와 Python 테스트 24개를 통과하며, 같은 검증은 GitHub
