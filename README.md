...
| 전체 종목 글로벌 peer 확장 | ⬜ 예정 | 큐레이션 글로벌 후보를 전체 종목으로 확대 |
...
- 텍스트 최근접 후보에 동일 업종·공통 제품 후보를 추가해 후보 누락 방지
...
5. [ ] 전체 종목의 글로벌 peer 비교 확장
6. [ ] 관련 ETF 연결 및 주요 구성 종목 표시
7. [ ] 개별 종목과 ETF 비교 기능 확장
