...
검증 후 웹에는 보고서 메타데이터와 유사도 결과만 별도 생성해 저장합니다.
...
웹 스냅샷에는 연간 사업 본문을 넣지 않고 보고서 기간, 접수일, 원문 URL,
텍스트 길이와 신뢰도만 저장합니다. 우선주는 보통주 사업 프로필을 참조하도록
별도 alias로 저장합니다. 스팩, 신규 상장 기업, 인프라 펀드는 일반 기업과
