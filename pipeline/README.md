...
다중 사업 노출은 `data/curated/business_exposure_rules.json`의 51개 태그를
KRX 업종·제품과 DART 사업 개요에서 추출합니다. 복합 기업과 순수 사업 기업을
비교하기 위해 가중 포함도 70%와 가중 Jaccard 30%를 결합합니다. 제품 점수는
양쪽 단어 수를 모두 반영하는 Dice 점수를 사용합니다. 기업 규모는 시가총액
비율의 4제곱근으로 완만하게 반영합니다.
