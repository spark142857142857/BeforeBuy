...
export const assets: Asset[] = [
  ...
  asset({ slug: "kodex-internet", ticker: "266360", name: "KODEX K-인터넷", nameEn: "KODEX K-Internet", market: "KR", type: "etf", sector: "플랫폼", industry: "국내 인터넷 ETF", summary: "국내 플랫폼, 게임, 핀테크 기업을 담는 ETF입니다.", profile: "NAVER·카카오 단일 기업 위험을 낮춘 국내 플랫폼 대안", exposures: ["플랫폼", "게임", "핀테크"], risks: ["내수 성장", "규제", "상위 종목 쏠림"], metrics: { per: 25.1, pbr: 1.7, revenueGrowth: 9.4, shareholderReturn: 0.8, volatility: 30, maxDrawdown: -34, return1y: 19.6 } }),
  ...
  asset({ slug: "tiger-bio", ticker: "227540", name: "TIGER 헬스케어", nameEn: "TIGER Healthcare", market: "KR", type: "etf", sector: "바이오", industry: "국내 헬스케어 ETF", summary: "국내 제약·바이오 대형주에 분산 투자합니다.", profile: "임상과 단일 제품 위험을 낮추는 국내 바이오 대안", exposures: ["바이오시밀러", "CDMO", "신약"], risks: ["국내 바이오 쏠림", "임상 이벤트", "고밸류"], metrics: { per: 38.2, pbr: 4.7, revenueGrowth: 17.4, shareholderReturn: 0.5, volatility: 30, maxDrawdown: -28, return1y: 38.5 } }),
  ...
  asset({ slug: "kodex-defense", ticker: "449450", name: "KODEX K-방산", nameEn: "KODEX K-Defense", market: "KR", type: "etf", sector: "산업재", industry: "국내 방산 ETF", summary: "국내 방산 수출 기업에 집중 투자합니다.", profile: "개별 수주 리스크를 낮추며 K-방산 생태계에 투자", exposures: ["지상 방산", "항공", "조선 방산"], risks: ["정책", "높은 변동성", "상위 종목 쏠림"], metrics: { per: 23.4, pbr: 4.2, revenueGrowth: 25.6, shareholderReturn: 0.9, volatility: 38, maxDrawdown: -30, return1y: 89.2 } }),
